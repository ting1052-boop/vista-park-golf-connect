...
export const automationDeviceRows = [
  ...
  { zone: "로비/홀", device: "비스타 홀.", type: "헤이홈 스위치", state: "대기", action: "공용 ON / 마감 OFF" },
...
export const showroomAutomationScenarios = [
  {
    name: "예약 10분 전 준비",
    trigger: "예약 시간 -10분",
    steps: "골프룸·로비 조명/AC → 해당 타석 PC(Tapo) → 프로젝터/리시버(헤이홈) ON"
  },
  {
    name: "입장 후 이용 시작",
  ...
  },
  {
    name: "이용 종료 정리",
    trigger: "예약 종료 시간 +5분",
    steps: "타석 PC/프로젝터/리시버 OFF → 골프룸·로비 조명/냉난방 정리 → 로그 저장"
  },
  {
    name: "마감 전체 OFF",
    trigger: "관리자 수동 실행",
