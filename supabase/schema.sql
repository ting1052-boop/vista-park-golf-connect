...
create table public.agent_round_events (
...
create index agent_round_events_store_occurred_idx
  on public.agent_round_events (store_id, occurred_at desc);
create index agent_round_events_bay_occurred_idx
...
revoke all on function public.store_agent_game_telemetry_if_newer(uuid, jsonb, timestamptz)
  from public, anon, authenticated;
grant execute on function public.store_agent_game_telemetry_if_newer(uuid, jsonb, timestamptz)
  to service_role;
