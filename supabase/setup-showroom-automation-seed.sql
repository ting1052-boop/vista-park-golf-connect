...
values
  ...
  ('ad111111-0107-4000-8000-000000000107', '11111111-1111-4111-8111-111111111111', 'aaaaaaaa-0001-4000-8000-000000000001', 'hejhome', 'screen_equipment', '1번 타석 골프프로젝터', 'hejhome-bay-01-projector', 'unknown', false, '프로젝터 전원 ON/OFF'),
  ('ad111111-0108-4000-8000-000000000108', '11111111-1111-4111-8111-111111111111', 'aaaaaaaa-0002-4000-8000-000000000002', 'hejhome', 'screen_equipment', '2번타석 SONY프로젝터', 'hejhome-bay-02-sony-projector', 'unknown', false, '프로젝터 전원 ON/OFF'),
  ('ad111111-0201-4000-8000-000000000201', '11111111-1111-4111-8111-111111111111', 'aaaaaaaa-0001-4000-8000-000000000001', 'tapo', 'smart_plug', '1번타석 골프', 'tapo-bay-01-pc', 'unknown', false, 'PC 전원 인가. 전원 인가 후 자동부팅'),
  ('ad111111-0202-4000-8000-000000000202', '11111111-1111-4111-8111-111111111111', 'aaaaaaaa-0002-4000-8000-000000000002', 'tapo', 'smart_plug', '2번타석', 'tapo-bay-02-pc', 'unknown', false, 'PC 전원 인가. 전원 인가 후 자동부팅'),
  ('ad111111-0203-4000-8000-000000000203', '11111111-1111-4111-8111-111111111111', null, 'tapo', 'smart_plug', '3번 타석', 'tapo-bay-03-pc', 'unknown', false, 'PC 전원 인가. 전원 인가 후 자동부팅'),
...
values
  ('as111111-0101-4000-8000-000000000101', '11111111-1111-4111-8111-111111111111', '시흥 쇼룸 예약 10분 전 준비', 'reservation_prepare', -10, false, '골프룸, 냉난방, 해당 타석 전원을 예약 전 준비'),
  ('as111111-0102-4000-8000-000000000102', '11111111-1111-4111-8111-111111111111', '시흥 쇼룸 이용 종료 정리', 'session_end', 5, false, '종료 후 타석 PC/프로젝터/조명 정리'),
